...
document.getElementById("hour1").innerHTML = currentHours;
document.getElementById("minute1").innerHTML = currentMinutes;
document.getElementById("ampm1").innerHTML = timeOfDay;
